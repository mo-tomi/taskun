...
### v1.5.5 (2025-01-10) - 時間軸間隔の拡大 📐
**縦軸の時間表示をより見やすく改善**

#### ✨ 改善内容
- **時間間隔の拡大**: 1時間あたり64px → 96px（1.5倍）に変更
- **30分マークの最適化**: 拡大された間隔に合わせて30分ラインを適切に配置
- **現在時刻インジケーター調整**: 新しい時間スケールに対応した正確な位置表示
- **タスク表示エリア拡張**: より広いスペースでタスクの詳細が確認しやすく

#### 🎯 視認性の向上
- **時間の読み取りやすさ**: 30分ごとの区切りがより明確に
- **タスク配置の精密性**: 広い間隔により、短時間タスクも正確に表示
- **スクロール体験の改善**: ゆったりとした時間軸でストレスフリーなナビゲーション
- **操作精度の向上**: ドラッグ&ドロップ時の時間調整がより精密に
...
- **動的高さ計算**: `height: ${18 * PIXELS_PER_HOUR + 192}px`
- **30分マーク位置**: `top: ${PIXELS_PER_HOUR / 2}px`
