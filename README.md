...
### v1.5.9 (2025-01-12) - UI/UX 改善 ✨
**タスク追加や達成時のアニメーションを強化し、進捗表示を見やすく調整**

#### 🔧 変更点
- クイック追加ボタンにバウンス効果を追加して目立たせました
- タスクがない日の画面にキラキラの案内を表示
- 進捗バーを太くし、グラデーションカラーを適用
- 完了したタスクがポップするマイクロアニメーションを実装

### v1.5.8 (2025-01-11) - ダークモード機能の削除 🌞
**ライトテーマに統一し、設定からダークモード関連オプションを廃止**

#### 🔧 変更点
- `useTheme` フックをライトテーマ固定に簡素化
- ダークモード切り替えに関する処理を無効化

#### 💡 理由
- ユーザーからの要望により、常にライトテーマで提供するため
